...
/****** Object:  StoredProcedure [dbo].[cognetic_custom_GeneralStaff_FreeTicket_v3]    Script Date: 16.06.2016 17:03:53 ******/

IF EXISTS (SELECT 1 FROM sysobjects where id = object_id(N'dbo.cbm_spGeneralStaffFreeTicket_v3') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
BEGIN
	DROP PROCEDURE dbo.cbm_spGeneralStaffFreeTicket_v3
END
GO
...
CREATE PROCEDURE [dbo].[cbm_spGeneralStaffFreeTicket_v3]
(
...
GRANT  EXECUTE  ON [dbo].[cbm_spGeneralStaffFreeTicket_v3]   TO PUBLIC
